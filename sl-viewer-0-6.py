...
def login_second_life(username, password, grid_uri, start_location="last"):
    ...
    client.Settings.LOGIN_CHANNEL = "SL-Viewer"  # Nome do visualizador

    # Aumenta o timeout de login
    client.Settings.LOGIN_TIMEOUT = 60  # 60 segundos de timeout para a conexão
