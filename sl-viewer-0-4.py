...
def login_second_life(username, password, grid_uri, start_location="last"):
    ...
    # Aqui dividimos o nome completo em primeiro e último nome
    first_name, last_name = username.split(" ")

    # Configuração dos parâmetros de login usando LoginParams
    login_params = LoginParams()
    login_params.FirstName = first_name  # Primeiro nome do avatar
    login_params.LastName = last_name  # Último nome do avatar
    login_params.Password = password  # Senha (formato MD5 com hash, caso necessário)
    login_params.URI = grid_uri  # URI do grid para o login
